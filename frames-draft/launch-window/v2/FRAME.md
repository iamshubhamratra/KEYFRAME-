...
description: >
  ...
  One accent (#7c3aed) marks a single focal device per frame; #fb6b35 is the secondary.
...
Launch Window is a bright modern SaaS system: near-white ground, soft brand gradients, friendly rounded type and one vivid gradient accent — for SaaS explainers, product tours and launches. A bright launch pack — violet-to-ember gradient light, bold geometric caps and motion that builds toward the reveal, for feature announcements and changelog films. The ground is light (#f9fafd); text is
ink #0d1220 on it. Exactly **one accent
device** (#7c3aed) per frame marks the single focal point; #fb6b35 is a supporting hue. Restraint carries
...
(a rule, dot, underline, or the single CTA fill); `#fb6b35` supports it. No third saturated hue in a
...
- Set display in Sora, fit-to-measure; body in Inter; labels in Inter caps.

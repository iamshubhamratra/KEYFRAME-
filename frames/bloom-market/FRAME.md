---
version: alpha
name: Bloom Market — Frame
description: >
  falling petals, swaying stems, a watering can arc Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "BloomMarket") — it renders the ORIGINAL bundled Bloom Market
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/BloomMarket.html`.

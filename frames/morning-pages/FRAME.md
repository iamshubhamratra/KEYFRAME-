...
# MORNING PAGES — personal blog / diary

The world is **the table before anyone else is up**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #f3ece1 · `surface` #fbf7f1 · `rule` #d5c9b8 · `inkMuted` #736a5d · `ink` #1b1712 · `accent` #e07a5f · `accent2` #81a06b · `accentInk` #fbf7f1
...
**Caveat** sets display, **Nunito** sets the argument at a measure declared

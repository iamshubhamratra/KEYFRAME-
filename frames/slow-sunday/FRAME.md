...
# SLOW SUNDAY — personal blog / diary

The world is **the front room, mid-afternoon**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #f1e7e6 · `surface` #fbf6f5 · `rule` #d6c5c3 · `inkMuted` #726466 · `ink` #1b1517 · `accent` #8a4a6a · `accent2` #d8a13c · `accentInk` #fbf6f5
...
**Grandstander** sets display, **Sen** sets the argument at a measure declared

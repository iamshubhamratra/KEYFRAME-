# Koi Hour — long-form kinetic-typography film (16:9)

A 5:04, 46-beat looping film for koi pond keeping, rendered from its own
...
## Design system
- Paper `#f2f4ee`, ink `#122528`, accent `#e07a3c`, second accent
  `#4d8c8c`, tinted grounds `#e2eeea` / `#f6e5d6`.
- **Cormorant Garamond** display over **Jost** body (bundled in the standalone).
...
- Animated SVG world behind every scene: koi circling the pond, ripple rings spreading, lily pads drifting, dragonfly hovering.

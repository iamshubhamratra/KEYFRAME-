---
version: alpha
name: Steam Spring — Frame
description: >
  onsen — steam columns, rock pool, snowfall, lantern Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "SteamSpring") — it renders the ORIGINAL bundled Steam Spring
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/SteamSpring.html`.

...
# LOOSE LEAF — literary / essay

The world is **a sheet of paper on its way down**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #eef0e6 · `surface` #fbfcf7 · `rule` #ccd2be · `inkMuted` #6d7360 · `ink` #151810 · `accent` #4f7a45 · `accent2` #e0995c · `accentInk` #fbfcf7
...
**Young Serif** sets display, **Figtree** sets the argument at a measure declared

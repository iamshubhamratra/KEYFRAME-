...
# HOME DESK — personal blog / diary

The world is **the corner you work in**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #efeadf · `surface` #fbf9f4 · `rule` #d0c9ba · `inkMuted` #6f6a5f · `ink` #1a1813 · `accent` #2f7d78 · `accent2` #c9743c · `accentInk` #fbf9f4
...
**Neucha** sets display, **Cabin** sets the argument at a measure declared

---
version: alpha
name: Lock & Legend — Frame
description: >
  keyhole light, fast clock, popping padlock, gears Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "LockAndLegend") — it renders the ORIGINAL bundled Lock & Legend
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/LockAndLegend.html`.

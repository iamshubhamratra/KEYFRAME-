...
# DEEP FIELD — science / explainer

The world is **an observatory at night**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #0b1020 · `surface` #141b30 · `rule` #283354 · `inkMuted` #8b96b8 · `ink` #f2f5fc · `accent` #5ce1ff · `accent2` #ff9f5c · `accentInk` #050810
...
**Orbitron** sets display, **Lexend** sets the argument at a measure declared

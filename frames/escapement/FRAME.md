---
version: alpha
name: Escapement — Frame
description: >
  gear train, oscillating balance wheel, mainspring, loupe Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Escapement") — it renders the ORIGINAL bundled Escapement
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Escapement.html`.

---
version: alpha
name: Star Watch — Frame
description: >
  constellation draw, telescope, meteor streak Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "StarWatch") — it renders the ORIGINAL bundled Star Watch
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/StarWatch.html`.

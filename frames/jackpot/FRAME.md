...
name: Jackpot — Frame
description: >
  "JACKPOT" casino slot-machine world. Reels, bulbs, coins. Portrait-native 9:16 (9 authored beats, 28s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Jackpot") — it renders the ORIGINAL bundled Jackpot
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Jackpot.html`.
...
| **Reels** | authored scene shape |
| **Bigscreen** | authored scene shape |
| **Payout** | authored scene shape |
| **Highcard** | authored scene shape |
| **Cashout** | authored scene shape |

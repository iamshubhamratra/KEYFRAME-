---
version: alpha
name: Serif Manifesto — Frame
description: >
  pure editorial typography — no image slots at all Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "SerifManifesto") — it renders the ORIGINAL bundled Serif Manifesto
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/SerifManifesto.html`.

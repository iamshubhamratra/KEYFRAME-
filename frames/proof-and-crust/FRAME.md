# Proof & Crust — long-form kinetic-typography film (16:9)

A 5:08, 46-beat looping film for bakery / sourdough, rendered from its own
...
## Design system
- Paper `#f8efdc`, ink `#261c14`, accent `#c06a26`, second accent
  `#6b7a4a`, tinted grounds `#e9eedd` / `#f9e3c6`.
- **Bevan** display over **Commissioner** body (bundled in the standalone).
...
- Animated SVG world behind every scene: dough dome rising and falling, oven glowing with loaves, flour specks falling, scoring blade cutting, steam curling up.

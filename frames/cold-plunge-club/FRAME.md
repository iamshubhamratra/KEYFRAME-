---
version: alpha
name: Cold Plunge Club — Frame
description: >
  ice hole, breath puffs, sauna hut, snow Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "ColdPlungeClub") — it renders the ORIGINAL bundled Cold Plunge Club
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/ColdPlungeClub.html`.

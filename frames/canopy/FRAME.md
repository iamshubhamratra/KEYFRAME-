# Canopy — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for rainforest / ecology, rendered from its own
...
## Design system
- Paper `#eef0e2`, ink `#16241c`, accent `#d98c2c`, second accent
  `#3f8c5f`, tinted grounds `#e4ece2` / `#f4e6cf`.
- **Vollkorn** display over **Alegreya Sans** body (bundled in the standalone).
...
- Animated SVG world behind every scene: swaying leaf layers, light shafts, drips, hanging vine.

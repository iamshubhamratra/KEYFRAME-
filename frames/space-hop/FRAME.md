---
version: alpha
name: Space Hop — Frame
description: >
  parallax starfield, ringed planet, thruster rocket Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "SpaceHop") — it renders the ORIGINAL bundled Space Hop
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/SpaceHop.html`.

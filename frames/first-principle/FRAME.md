...
# FIRST PRINCIPLE — science / explainer

The world is **a demonstration bench**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #eff1f0 · `surface` #fcfdfc · `rule` #cbd0ce · `inkMuted` #6c7371 · `ink` #0f1211 · `accent` #3f5fd8 · `accent2` #d8a03f · `accentInk` #fcfdfc
...
**Big Shoulders Display** sets display, **Assistant** sets the argument at a measure declared

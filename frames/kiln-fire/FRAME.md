# Kiln Fire — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for ceramics / pottery, rendered from its own
...
## Design system
- Paper `#f3ebde`, ink `#241d17`, accent `#c2562c`, second accent
  `#5f8c8c`, tinted grounds `#e6eeee` / `#f7e2d2`.
- **Gloock** display over **Schibsted Grotesk** body (bundled in the standalone).
...
- Animated SVG world behind every scene: wobbling wheel with rising pot, glowing kiln, bending cone.

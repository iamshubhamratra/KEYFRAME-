...
# BYLINE RULE — news / journalism

The world is **the press pit**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #0e0f11 · `surface` #191b1e · `rule` #2c3034 · `inkMuted` #8b9095 · `ink` #f7f8f9 · `accent` #f2d13c · `accent2` #d0473c · `accentInk` #0b0c0d
...
**Oswald** sets display, **PT Sans** sets the argument at a measure declared

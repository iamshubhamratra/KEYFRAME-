---
version: alpha
name: Scoop Lab — Frame
description: >
  dripping scoop, falling sprinkles, cherry bounce Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "ScoopLab") — it renders the ORIGINAL bundled Scoop Lab
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/ScoopLab.html`.

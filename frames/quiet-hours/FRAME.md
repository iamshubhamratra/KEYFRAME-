...
# QUIET HOURS — literary / essay

The world is **the desk lamp is lit and a moth is working the light**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #efe6d4 · `surface` #f9f3e6 · `rule` #cfc2a6 · `inkMuted` #6f6552 · `ink` #1b1710 · `accent` #b8813a · `accent2` #6f7f5c · `accentInk` #1b1710
...
**EB Garamond** sets display, **Andada Pro** sets the argument at a measure declared

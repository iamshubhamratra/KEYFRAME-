...
name: Repzone — Frame
description: >
  "REPZONE" gym world. Barbells, rep counters, chalk. Portrait-native 9:16 (9 authored beats, 27.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Repzone") — it renders the ORIGINAL bundled Repzone
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Repzone.html`.
...
| Shape | Notes |
|---|---|
| **Warmup** | authored scene shape |
| **Circuitboard** | authored scene shape |
| **Mirrorwall** | authored scene shape |
| **Prboard** | authored scene shape |
| **Lockerroom** | authored scene shape |
| **Gotime** | authored scene shape |

---
version: alpha
name: Dawn Patrol — Frame
description: >
  run club — road dashes, bobbing runner, rising sun Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "DawnPatrol") — it renders the ORIGINAL bundled Dawn Patrol
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/DawnPatrol.html`.

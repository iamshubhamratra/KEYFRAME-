...
# COPY DESK — news / journalism

The world is **the copy floor at deadline**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #e6e8e2 · `surface` #f6f8f4 · `rule` #c3c8bd · `inkMuted` #697064 · `ink` #141712 · `accent` #2f7d7a · `accent2` #d97a2f · `accentInk` #f6f8f4
...
**Barlow Condensed** sets display, **Barlow** sets the argument at a measure declared

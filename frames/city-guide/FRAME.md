...
# CITY GUIDE — lifestyle / culture

The world is **a street at the end of the day**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #eef0f2 · `surface` #fbfcfd · `rule` #c8cdd2 · `inkMuted` #6a7075 · `ink` #111417 · `accent` #2f4f8c · `accent2` #c9803a · `accentInk` #fbfcfd
...
**Playfair Display** sets display, **Poppins** sets the argument at a measure declared

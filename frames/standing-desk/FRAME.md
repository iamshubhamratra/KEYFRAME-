# Standing Desk — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for workspace / deep work, rendered from its own
...
## Design system
- Paper `#f0f1ee`, ink `#191c20`, accent `#3c6be0`, second accent
  `#e0913c`, tinted grounds `#e6ecf2` / `#f6e8d8`.
- **Familjen Grotesk** display over **Public Sans** body (bundled in the standalone).
...
- Animated SVG world behind every scene: a desk with a laptop lid opening, cursor blinking under text lines, a coiled cable, a swaying potted plant, shelf slabs.

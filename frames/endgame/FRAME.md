...
name: Endgame — Frame
description: >
  chess club — board corner, knight hop, ticking clock Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Endgame") — it renders the ORIGINAL bundled Endgame
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Endgame.html`.

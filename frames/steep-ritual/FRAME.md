---
version: alpha
name: Steep Ritual — Frame
description: >
  tea house — steam curl, bowl, bamboo sway Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "SteepRitual") — it renders the ORIGINAL bundled Steep Ritual
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/SteepRitual.html`.

---
version: alpha
name: Prop Wash — Frame
description: >
  LED gates, banking quad, streaks Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "PropWash") — it renders the ORIGINAL bundled Prop Wash
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/PropWash.html`.

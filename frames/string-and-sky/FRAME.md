---
version: alpha
name: String & Sky — Frame
description: >
  kites with wiggling tails, clouds, grass Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "StringAndSky") — it renders the ORIGINAL bundled String & Sky
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/StringAndSky.html`.

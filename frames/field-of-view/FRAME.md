# Field of View — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for astronomy, rendered from its own
...
## Design system
- Paper `#e9e6f2`, ink `#080b16`, accent `#e0c46b`, second accent
  `#7a8ad0`, tinted grounds `#101828` / `#181022`.
- **Prata** display over **Manrope** body (bundled in the standalone).
...
- Animated SVG world behind every scene: twinkling stars, constellation drawing, rotating dome, meteors.

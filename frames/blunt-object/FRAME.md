...
# BLUNT OBJECT — creative / portfolio

The world is **hoarding with pasted bills under a gap in the skyline; a crane mast in the margin; the ball swings a 4**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #e9e3d6 · `surface` #f7f3ea · `rule` #c6bda8 · `inkMuted` #6d675a · `ink` #151309 · `accent` #f2600c · `accent2` #2f5f7a · `accentInk` #f7f3ea
...
**Anton** sets display, **Rubik** sets the argument at a measure declared

---
version: alpha
name: Retro Arcade — Frame
description: >
  pixel starfield, invader march, scanline sweep Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "RetroArcade") — it renders the ORIGINAL bundled Retro Arcade
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/RetroArcade.html`.

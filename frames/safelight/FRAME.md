# Safelight — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for darkroom photography, rendered from its own
...
## Design system
- Paper `#efe9df`, ink `#16110f`, accent `#e2483d`, second accent
  `#c9922c`, tinted grounds `#1c1614` / `#221614`.
- **Syne** display over **Hanken Grotesk** body (bundled in the standalone).
...
- Animated SVG world behind every scene: pulsing red bulb, swaying negatives, tray ripples.

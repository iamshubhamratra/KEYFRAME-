---
version: alpha
name: Ocean Dive — Frame
description: >
  "Ocean Dive" Descent into deep water: rising bubble columns, slow-rotating light rays from the surface, a drifting fish school, floating content. Comfortaa + Mulish. Portrait-native 9:16 (18 authored beats, 49.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "OceanDive") — it renders the ORIGINAL bundled Ocean Dive
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/OceanDive.html`.

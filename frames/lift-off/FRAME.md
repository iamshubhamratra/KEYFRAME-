...
name: Lift Off — Frame
description: >
  hot-air balloon rising, gore stripes, drifting clouds Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "LiftOff") — it renders the ORIGINAL bundled Lift Off
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/LiftOff.html`.

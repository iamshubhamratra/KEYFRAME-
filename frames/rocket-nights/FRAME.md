---
version: alpha
name: Rocket Nights — Frame
description: >
  launches, radial bursts, sparkles, hill Portrait-native 9:16 (14 authored beats, 41.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "RocketNights") — it renders the ORIGINAL bundled Rocket Nights
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/RocketNights.html`.

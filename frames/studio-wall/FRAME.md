...
# STUDIO WALL — creative / portfolio

The world is **pinned prints lifting at the corners; a mobile in the margin whose three arms turn at three rates; an easel and paint tins on the floor**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #eae7e4 · `surface` #f8f6f5 · `rule` #c7c2be · `inkMuted` #6b6663 · `ink` #161315 · `accent` #e0347f · `accent2` #3f8f7f · `accentInk` #f8f6f5
...
**Syne** sets display, **Hanken Grotesk** sets the argument at a measure declared

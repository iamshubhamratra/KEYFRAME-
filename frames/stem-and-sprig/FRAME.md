# Stem & Sprig — long-form kinetic-typography film (16:9)

A 5:08, 46-beat looping film for wedding florist, rendered from its own
...
## Design system
- Paper `#faf4f0`, ink `#2a2026`, accent `#c4738a`, second accent
  `#7a9070`, tinted grounds `#e8eee6` / `#f8e6e6`.
- **Italiana** display over **Albert Sans** body (bundled in the standalone).
...
- Animated SVG world behind every scene: stems swaying with turning flower heads, petals drifting down, ribbon spiral drawing outward, wreath ring of turning petals.

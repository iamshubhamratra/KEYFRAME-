...
description: >
  ...
  One accent (#2FB39A) marks a single focal device per frame; #FF9E7A is the secondary.
...
Ground `#F3FAF7`. Text is high-contrast ink. `#2FB39A` is the one saturated device per frame
(a rule, dot, underline, or the single CTA fill); `#FF9E7A` supports it. No third saturated hue in a

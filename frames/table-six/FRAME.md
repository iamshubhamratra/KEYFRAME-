...
# TABLE SIX — lifestyle / culture

The world is **a restaurant, service on**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #efe9e2 · `surface` #fbf8f4 · `rule` #cbc0b3 · `inkMuted` #6e665c · `ink` #16130f · `accent` #8c3a2f · `accent2` #5f7a4a · `accentInk` #fbf8f4
...
**DM Serif Display** sets display, **DM Sans** sets the argument at a measure declared

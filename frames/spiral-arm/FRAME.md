# Spiral Arm — long-form kinetic-typography film (16:9)

A 5:08, 46-beat looping film for astronomy / the galaxy, rendered from its own
...
## Design system
- Paper `#eceaf8`, ink `#080614`, accent `#c4a0e0`, second accent
  `#5fa0d0`, tinted grounds `#101828` / `#1c1224`.
- **Italiana** display over **Sen** body (bundled in the standalone).
...
- Animated SVG world behind every scene: a face-on spiral galaxy slowly rotating with four density-wave arms and a glowing core, a scattered twinkling starfield, a separate pulsing 'you are here' marker ringed and labelled at the far side of the frame.

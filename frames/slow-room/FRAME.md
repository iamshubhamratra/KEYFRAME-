...
# SLOW ROOM — lifestyle / culture

The world is **a veranda in the late afternoon**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #efe6d9 · `surface` #fbf6ee · `rule` #cec0ac · `inkMuted` #6f6558 · `ink` #17130e · `accent` #b0623a · `accent2` #5f7f72 · `accentInk` #fbf6ee
...
**Yeseva One** sets display, **Outfit** sets the argument at a measure declared

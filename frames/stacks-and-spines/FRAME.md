---
version: alpha
name: Stacks & Spines — Frame
description: >
  shelf spines, lamp glow, dust motes Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "StacksAndSpines") — it renders the ORIGINAL bundled Stacks & Spines
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/StacksAndSpines.html`.

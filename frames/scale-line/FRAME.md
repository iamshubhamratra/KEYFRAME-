---
version: alpha
name: Scale Line — Frame
description: >
  oval track loop, tunnel, cone trees, signal arm Portrait-native 9:16 (14 authored beats, 41.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "ScaleLine") — it renders the ORIGINAL bundled Scale Line
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/ScaleLine.html`.

---
version: alpha
name: Alpine Post — Frame
description: >
  cable car crossing, peaks, snow, postmark stamp Portrait-native 9:16 (14 authored beats, 41.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "AlpinePost") — it renders the ORIGINAL bundled Alpine Post
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/AlpinePost.html`.

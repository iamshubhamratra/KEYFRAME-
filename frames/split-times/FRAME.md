# Split Times — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for running, rendered from its own
...
## Design system
- Paper `#eef3f6`, ink `#141a20`, accent `#ff5a3c`, second accent
  `#2ba3c4`, tinted grounds `#e2eef0` / `#f7e3dc`.
...
- Animated SVG world behind every scene: bobbing runner, curved track, live split readout.

---
version: alpha
name: Semolina Club — Frame
description: >
  rolling pin, flour puffs, pasta ribbons, ravioli Portrait-native 9:16 (14 authored beats, 41.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "SemolinaClub") — it renders the ORIGINAL bundled Semolina Club
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/SemolinaClub.html`.

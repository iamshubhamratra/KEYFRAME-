# Col & Cairn — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for hillwalking / mountaineering, rendered from its own
...
## Design system
- Paper `#f0f2ee`, ink `#1a222b`, accent `#c4572c`, second accent
  `#4d7a8c`, tinted grounds `#e4ecec` / `#f6e2d4`.
- **Vollkorn** display over **Barlow** body (bundled in the standalone).
...
- Animated SVG world behind every scene: jagged ridgeline with snowcaps, cloud inversion drifting through the valley, cairn stones stacking one by one, hiker with a pole climbing.

...
name: Toybox — Frame
description: >
  "TOYBOX" playroom world. Building blocks, balloons, wind-up robot. Portrait-native 9:16 (9 authored beats, 27.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Toybox") — it renders the ORIGINAL bundled Toybox
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Toybox.html`.
...
| Shape | Notes |
|---|---|
| **Playmat** | authored scene shape |
| **Blocks** | authored scene shape |
| **Screentime** | authored scene shape |
| **Scoreboard** | authored scene shape |
| **Storytime** | authored scene shape |
| **Windup** | authored scene shape |

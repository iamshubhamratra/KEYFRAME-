---
version: alpha
name: Groove Crate — Frame
description: >
  record store — spinning grooves, tonearm, crate cards Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "GrooveCrate") — it renders the ORIGINAL bundled Groove Crate
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/GrooveCrate.html`.

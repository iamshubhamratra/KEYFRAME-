# Tide Table — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for coast / sea swimming, rendered from its own
...
## Design system
- Paper `#f6f1e2`, ink `#14262e`, accent `#e8763c`, second accent
  `#2c8c9e`, tinted grounds `#e2eeec` / `#f8e4cd`.
- **Chonburi** display over **Prompt** body (bundled in the standalone).
...
- Animated SVG world behind every scene: four wave layers, spinning parasol, gulls, sun glare.

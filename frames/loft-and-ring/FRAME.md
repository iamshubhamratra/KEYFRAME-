# Loft & Ring — long-form kinetic-typography film (16:9)

A 5:08, 46-beat looping film for pigeon racing, rendered from its own
...
## Design system
- Paper `#f4f0e4`, ink `#252017`, accent `#a86a3c`, second accent
  `#5f7a8c`, tinted grounds `#e8eeec` / `#f7e6d2`.
- **Bree Serif** display over **Asap** body (bundled in the standalone).
...
- Animated SVG world behind every scene: pigeons flapping across the sky, a nest-box loft with birds on the landing board, a sweeping race clock, rolling hills.

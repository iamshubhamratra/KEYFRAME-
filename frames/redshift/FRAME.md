...
name: Redshift — Frame
description: >
  "REDSHIFT" mars-expedition world. Dust, rover, habitats. Portrait-native 9:16 (9 authored beats, 28s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Redshift") — it renders the ORIGINAL bundled Redshift
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Redshift.html`.
...
| Shape | Notes |
|---|---|
| **Sol** | authored scene shape |
| **Traverse** | authored scene shape |
| **Habitat** | authored scene shape |
| **Core** | authored scene shape |

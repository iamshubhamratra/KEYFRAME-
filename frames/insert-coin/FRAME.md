# Insert Coin — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for retro arcade, rendered from its own
...
## Design system
- Paper `#eef0ff`, ink `#0b0b16`, accent `#ffd23c`, second accent
  `#3cffd2`, tinted grounds `#101a24` / `#1a1024`.
- **Press Start 2P** display over **Space Grotesk** body (bundled in the standalone).
...
- Animated SVG world behind every scene: glowing pixel grid, a chunky sprite bouncing across, flickering high-score board, joystick rocking with lit buttons.

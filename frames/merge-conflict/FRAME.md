# Merge Conflict — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for code review / version control, rendered from its own
...
## Design system
- Paper `#e6edf3`, ink `#0c1017`, accent `#5ce08a`, second accent
  `#e05c8a`, tinted grounds `#121a22` / `#1a1220`.
- **Space Grotesk** display over **IBM Plex Sans** body (bundled in the standalone).
...
- Animated SVG world behind every scene: diff lines in green and pink gutters, a blinking cursor, giant curly braces, test dots and a coverage bar.

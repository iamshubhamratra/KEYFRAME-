...
name: Sushi — Frame
description: >
  "SUSHI" conveyor-bar world. Noren, plates, steam, lanterns. Portrait-native 9:16 (9 authored beats, 27.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Sushi") — it renders the ORIGINAL bundled Sushi
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Sushi.html`.
...
| Shape | Notes |
|---|---|
| **Irasshai** | authored scene shape |
| **Omakase** | authored scene shape |
| **Menuboard** | authored scene shape |
| **Tally** | authored scene shape |
| **Ticket** | authored scene shape |
| **Kanpai** | authored scene shape |

...
# RUNWAY MATH — business / analyst

The world is **a balloon at dusk, losing height between burns**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #12111c · `surface` #1c1b2b · `rule` #302f45 · `inkMuted` #8f8da8 · `ink` #f1f0f7 · `accent` #9b7bff · `accent2` #ffb15c · `accentInk` #0b0a12
...
**Sora** sets display, **Epilogue** sets the argument at a measure declared

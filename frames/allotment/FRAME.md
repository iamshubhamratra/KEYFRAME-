# Allotment — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for vegetable plot, rendered from its own
...
## Design system
- Paper `#f2f0e0`, ink `#22301f`, accent `#c4622c`, second accent
  `#4d8c3f`, tinted grounds `#e6eedc` / `#f6e3cd`.
- **Zilla Slab** display over **Source Sans 3** body (bundled in the standalone).
...
- Animated SVG world behind every scene: rows of seedlings growing, watering can, hopping robin.

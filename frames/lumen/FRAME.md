...
renderer: >
  ...
  "template": "Lumen") — it renders the ORIGINAL bundled Lumen
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Lumen.html`.
...
10 authored beats (36.8s as shipped) across 10 distinct shapes.
...
| Shape | Notes |
|---|---|
| **Spot** | authored scene shape |
| **Neon** | authored scene shape |
| **Sweep** | authored scene shape |
| **Sundial** | authored scene shape |
| **Rays** | authored scene shape |
| **Window** | authored scene shape |
| **Strobe** | authored scene shape |
| **Beacon** | authored scene shape |
| **Marquee** | authored scene shape |

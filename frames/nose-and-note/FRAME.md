---
version: alpha
name: Nose & Note — Frame
description: >
  flacons, scent curls, blotter fan Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "NoseAndNote") — it renders the ORIGINAL bundled Nose & Note
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/NoseAndNote.html`.

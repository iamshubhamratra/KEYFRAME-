---
version: alpha
name: Safari Dawn — Frame
description: >
  savanna sunrise, acacia silhouettes, striding gazelles Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "SafariDawn") — it renders the ORIGINAL bundled Safari Dawn
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/SafariDawn.html`.

---
version: alpha
name: Sole Drop — Frame
description: >
  sneaker release — speed lines, tread zigzag, bouncing ball Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "SoleDrop") — it renders the ORIGINAL bundled Sole Drop
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/SoleDrop.html`.

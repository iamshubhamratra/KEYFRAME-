...
name: Cat Nap — Frame
description: >
  "Cat Nap" Twilight living room: window with drifting stars and moon, pulsing lamp glow, rolling yarn ball trailing thread, dust motes, a cat silhouette with a slow tail flick. Quicksand + Lora. Portrait-native 9:16 (18 authored beats, 49.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "CatNap") — it renders the ORIGINAL bundled Cat Nap
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/CatNap.html`.

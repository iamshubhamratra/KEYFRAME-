---
version: alpha
name: Type Riot — Frame
description: >
  "Type Riot" Pure kinetic typography: giant Anton word slams, per-letter cascades, outline/fill flips, a huge drifting ghost word behind everything. Black / off-white / riot red. Portrait-native 9:16 (18 authored beats, 49.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "TypeRiot") — it renders the ORIGINAL bundled Type Riot
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/TypeRiot.html`.

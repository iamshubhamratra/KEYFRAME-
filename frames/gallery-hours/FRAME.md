...
# GALLERY HOURS — creative / portfolio

The world is **three framed works with labels; a ceiling track and one light head sliding a 16s pass, its cone brightening each work as it passes; a bench and a visitor who stops, looks and moves on**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #f2f0ec · `surface` #fdfcfa · `rule` #d2cec7 · `inkMuted` #6f6b64 · `ink` #141311 · `accent` #1f4f4a · `accent2` #c9a34f · `accentInk` #fdfcfa
...
**Italiana** sets display, **Jost** sets the argument at a measure declared

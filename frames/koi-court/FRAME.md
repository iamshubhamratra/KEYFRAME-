---
version: alpha
name: Koi Court — Frame
description: >
  koi circling, ripples, lily pads, maple leaf Portrait-native 9:16 (14 authored beats, 41.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "KoiCourt") — it renders the ORIGINAL bundled Koi Court
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/KoiCourt.html`.

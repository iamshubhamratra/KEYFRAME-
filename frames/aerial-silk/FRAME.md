---
version: alpha
name: Aerial Silk — Frame
description: >
  hanging silks that ripple, spotlight cone, swinging hoop Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "AerialSilk") — it renders the ORIGINAL bundled Aerial Silk
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/AerialSilk.html`.

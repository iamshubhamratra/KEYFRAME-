# Fret & Fingerboard — long-form kinetic-typography film (16:9)

A 5:08, 46-beat looping film for luthiery / guitar building, rendered from its own
...
## Design system
- Paper `#f6ecd8`, ink `#251b14`, accent `#a8622c`, second accent
  `#4d6b7a`, tinted grounds `#e8eeee` / `#f8e2c8`.
- **Zilla Slab** display over **Barlow** body (bundled in the standalone).
...
- Animated SVG world behind every scene: guitar body swaying with vibrating strings, fretboard and inlays, glue clamps turning, wood shavings curling.

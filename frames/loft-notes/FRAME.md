# Loft Notes — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for vinyl / record collecting, rendered from its own
...
## Design system
- Paper `#f2ebdd`, ink `#1a1420`, accent `#e0603c`, second accent
  `#3fb8a8`, tinted grounds `#1f2a2a` / `#2a1c22`.
- **Righteous** display over **Mulish** body (bundled in the standalone).
...
- Animated SVG world behind every scene: spinning platter, tracking tonearm, EQ bars, sleeve rack.

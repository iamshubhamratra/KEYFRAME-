...
renderer: >
  ...
  "template": "Dragboard") — it renders the ORIGINAL bundled Dragboard
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Dragboard.html`.
...
5 authored beats (15.1s as shipped) across 5 distinct shapes.
...
| Shape | Notes |
|---|---|
| **Tray** | authored scene shape |
| **Sort** | authored scene shape |
| **Stickers** | authored scene shape |
| **Feed** | authored scene shape |

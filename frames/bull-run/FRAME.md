# Bull Run — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for rodeo / bull riding, rendered from its own
...
## Design system
- Paper `#f7ecd8`, ink `#241610`, accent `#12d67a`, second accent
  `#f2b23c`, tinted grounds `#e8e8d8` / `#f8ddc4`.
...
- Animated SVG world behind every scene: a bucking bull with rider, arena fence rails, kicked dust, an eight-second clock.

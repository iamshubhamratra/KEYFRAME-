---
version: alpha
name: Kiln & Clay — Frame
description: >
  wheel wobble, pot growing, kiln temp squiggle Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "KilnAndClay") — it renders the ORIGINAL bundled Kiln & Clay
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/KilnAndClay.html`.

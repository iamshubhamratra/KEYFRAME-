---
version: alpha
name: Metro Line — Frame
description: >
  transit-map lines snaking, a train dot running them Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "MetroLine") — it renders the ORIGINAL bundled Metro Line
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/MetroLine.html`.

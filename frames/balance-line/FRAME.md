...
# BALANCE LINE — business / analyst

The world is **a counting house**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #f2eee4 · `surface` #fbf9f3 · `rule` #cec7b6 · `inkMuted` #6f695c · `ink` #161410 · `accent` #1f5137 · `accent2` #8c2f45 · `accentInk` #fbf9f3
...
**Libre Bodoni** sets display, **Livvic** sets the argument at a measure declared

# Six Bells — long-form kinetic-typography film (16:9)

A 5:08, 46-beat looping film for change ringing / bell tower, rendered from its own
...
## Design system
- Paper `#f4f0e6`, ink `#1e1b16`, accent `#9e7a2c`, second accent
  `#5f6b8c`, tinted grounds `#e8ece6` / `#f6e8d2`.
- **Cormorant Garamond** display over **Public Sans** body (bundled in the standalone).
...
- Animated SVG world behind every scene: six bells swinging on their ropes, sallies pulled below, sound rings spreading, a change grid lighting cell by cell.

...
name: Bluesite — Frame
description: >
  "BLUESITE" blueprint construction world. Chalk drafting, crane lifts, stamps. Portrait-native 9:16 (12 authored beats, 36.2s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Bluesite") — it renders the ORIGINAL bundled Bluesite
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Bluesite.html`.
...
| Shape | Notes |
|---|---|
| **TitleBlock** | authored scene shape |
| **Crane** | authored scene shape |
| **SitePhoto** | authored scene shape |
| **BOM** | authored scene shape |
| **Inspect** | authored scene shape |
| **Handover** | authored scene shape |

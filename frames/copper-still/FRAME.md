# Copper Still — long-form kinetic-typography film (16:9)

A 5:08, 46-beat looping film for whisky distillery, rendered from its own
...
## Design system
- Paper `#f4e9d6`, ink `#1f1610`, accent `#b8762c`, second accent
  `#5f7a6b`, tinted grounds `#e6eee8` / `#f7e0c4`.
- **Cinzel** display over **Radio Canada** body (bundled in the standalone).
...
- Animated SVG world behind every scene: copper pot still with swan neck, vapour rising through the condenser, spirit droplets falling, numbered oak casks.

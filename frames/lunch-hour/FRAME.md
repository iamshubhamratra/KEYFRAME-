# Lunch Hour — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for office lunch / workplace, rendered from its own
...
## Design system
- Paper `#f2f1ec`, ink `#1d2126`, accent `#f26b3c`, second accent
  `#2c7a6b`, tinted grounds `#e4ecea` / `#f7e4d8`.
...
- Animated SVG world behind every scene: sweeping clock, bento grid filling, queue of dots.

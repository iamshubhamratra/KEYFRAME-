...
# MARGIN NOTES — technical / documentation

The world is **a drafting desk**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #101418 · `surface` #181f25 · `rule` #2b363e · `inkMuted` #93a3ad · `ink` #e7eef3 · `accent` #4fb8e8 · `accent2` #f0a04b · `accentInk` #08131a
...
**Space Grotesk** sets display, **IBM Plex Sans** sets the argument at a measure declared

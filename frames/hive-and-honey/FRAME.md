---
version: alpha
name: Hive & Honey — Frame
description: >
  hex comb pop-in, bees on figure-8, honey drip Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "HiveAndHoney") — it renders the ORIGINAL bundled Hive & Honey
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/HiveAndHoney.html`.

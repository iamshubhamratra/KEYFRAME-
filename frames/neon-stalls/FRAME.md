# Neon Stalls — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for night market street food, rendered from its own
...
## Design system
- Paper `#f6eff6`, ink `#150c1c`, accent `#ff3ea0`, second accent
  `#2ee0d0`, tinted grounds `#1b2430` / `#241428`.
- **Monoton** display over **Be Vietnam Pro** body (bundled in the standalone).
...
- Animated SVG world behind every scene: two sagging lantern strings flickering, wok flame flaring, smoke plumes rising, stall awning and drifting crowd.

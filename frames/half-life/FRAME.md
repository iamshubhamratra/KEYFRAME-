...
# HALF LIFE — science / explainer

The world is **a counting chamber**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #10160f · `surface` #1a2318 · `rule` #2d3b2b · `inkMuted` #8fa08c · `ink` #f0f5ee · `accent` #a8e05c · `accent2` #e05ca8 · `accentInk` #080c07
...
**Michroma** sets display, **Sofia Sans** sets the argument at a measure declared

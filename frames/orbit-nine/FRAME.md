# Orbit Nine — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for astronomy / solar system, rendered from its own
...
## Design system
- Paper `#eef0fb`, ink `#0b0b1a`, accent `#e08a3c`, second accent
  `#3c8ce0`, tinted grounds `#101a28` / `#1e1220`.
- **Orbitron** display over **Exo 2** body (bundled in the standalone).
...
- Animated SVG world behind every scene: planets circling a pulsing sun on flattened orbit rings, a ringed gas giant, a comet crossing right to left, a twinkling starfield, a light-delay readout.

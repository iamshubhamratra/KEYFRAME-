---
version: alpha
name: Abyss Dive — Frame
description: >
  deep sea — bubbles, jellyfish, angler light, depth ruler Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "AbyssDive") — it renders the ORIGINAL bundled Abyss Dive
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/AbyssDive.html`.

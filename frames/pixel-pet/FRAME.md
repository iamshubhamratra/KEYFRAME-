---
version: alpha
name: Pixel Pet — Frame
description: >
  handheld-console world, 8-bit pet hopping, hearts, crumbs Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "PixelPet") — it renders the ORIGINAL bundled Pixel Pet
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/PixelPet.html`.

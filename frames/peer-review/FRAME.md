...
# PEER REVIEW — academic / research

The world is **the seminar room before anyone arrives**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #eceae4 · `surface` #f8f7f3 · `rule` #c6c4bc · `inkMuted` #6c6a63 · `ink` #15151a · `accent` #2b3a72 · `accent2` #b08a3c · `accentInk` #f8f7f3
...
**Marcellus** sets display, **Spectral** sets the argument at a measure declared

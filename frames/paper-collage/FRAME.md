---
version: alpha
name: Paper Collage — Frame
description: >
  Paper Cut: layered torn-paper waves, floating confetti scraps Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "PaperCollage") — it renders the ORIGINAL bundled Paper Collage
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/PaperCollage.html`.

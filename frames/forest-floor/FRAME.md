---
version: alpha
name: Forest Floor — Frame
description: >
  mushrooms popping, spores, fern sway Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "ForestFloor") — it renders the ORIGINAL bundled Forest Floor
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/ForestFloor.html`.

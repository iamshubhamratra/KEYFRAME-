---
version: alpha
name: Fold Studio — Frame
description: >
  origami — folding triangles, crane flap, crease lines Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "FoldStudio") — it renders the ORIGINAL bundled Fold Studio
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/FoldStudio.html`.

---
version: alpha
name: Kickflip Co — Frame
description: >
  halfpipe curve, skater dot with flip, spray splat Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "KickflipCo") — it renders the ORIGINAL bundled Kickflip Co
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/KickflipCo.html`.

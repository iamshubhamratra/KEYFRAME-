...
# QUARTER NOTE — business / analyst

The world is **a glass tower seen from the atrium**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #eef1f4 · `surface` #fafcfd · `rule` #c9d1d8 · `inkMuted` #6b747c · `ink` #121619 · `accent` #1f3a5f · `accent2` #8fc93a · `accentInk` #fafcfd
...
**Instrument Sans** sets display, **Manrope** sets the argument at a measure declared

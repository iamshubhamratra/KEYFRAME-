---
version: alpha
name: Ink & Brush — Frame
description: >
  sumi strokes drawing themselves, drifting mist, red seal Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "InkBrush") — it renders the ORIGINAL bundled Ink & Brush
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/InkBrush.html`.

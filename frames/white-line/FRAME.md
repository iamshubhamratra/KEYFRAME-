# White Line — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for ski patrol / avalanche control, rendered from its own
...
## Design system
- Paper `#f2f7fb`, ink `#0f1c2a`, accent `#e83c3c`, second accent
  `#2f7fd0`, tinted grounds `#e2eef8` / `#f8e2e2`.
- **Saira Condensed** display over **Saira** body (bundled in the standalone).
...
- Animated SVG world behind every scene: ridgeline peaks, falling snow, a skier arcing across the bowl, chairlifts crossing the cable.

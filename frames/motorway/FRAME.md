...
name: Motorway — Frame
description: >
  "MOTORWAY" road-trip world. Lane lines, exit signs, odometers. Portrait-native 9:16 (9 authored beats, 27.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Motorway") — it renders the ORIGINAL bundled Motorway
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Motorway.html`.
...
| Shape | Notes |
|---|---|
| **Ignition** | authored scene shape |
| **Exits** | authored scene shape |
| **Windshield** | authored scene shape |
| **Mileage** | authored scene shape |
| **Motel** | authored scene shape |
| **Arrival** | authored scene shape |

---
version: alpha
name: Molten Studio — Frame
description: >
  glowing gather, heat waves, orb shelf Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "MoltenStudio") — it renders the ORIGINAL bundled Molten Studio
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/MoltenStudio.html`.

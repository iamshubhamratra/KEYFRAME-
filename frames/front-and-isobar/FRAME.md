---
version: alpha
name: Front & Isobar — Frame
description: >
  isobars, wind barbs, cold front, rain hatch Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "FrontAndIsobar") — it renders the ORIGINAL bundled Front & Isobar
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/FrontAndIsobar.html`.

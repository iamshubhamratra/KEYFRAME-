---
version: alpha
name: Festival Stage — Frame
description: >
  sweeping spotlights, confetti rain, crowd silhouette Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "FestivalStage") — it renders the ORIGINAL bundled Festival Stage
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/FestivalStage.html`.

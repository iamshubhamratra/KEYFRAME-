...
# COLD TYPE — creative / portfolio

The world is **a wall of type cases; a guillotine that cycles every 5s, beam lifting, blade dropping, offcut sliding away, stack losing a sheet**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #f0f2f3 · `surface` #fcfdfd · `rule` #ccd0d3 · `inkMuted` #6c7276 · `ink` #101315 · `accent` #2b6bff · `accent2` #ff5a2b · `accentInk` #fcfdfd
...
**Unbounded** sets display, **Urbanist** sets the argument at a measure declared

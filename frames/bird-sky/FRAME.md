...
name: Bird Sky — Frame
description: >
  morning flock in formation, drifting clouds, kite Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "BirdSky") — it renders the ORIGINAL bundled Bird Sky
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/BirdSky.html`.

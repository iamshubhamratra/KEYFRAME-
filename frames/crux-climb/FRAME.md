---
version: alpha
name: Crux Climb — Frame
description: >
  wall angles, holds popping, chalk puff, rope swing Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "CruxClimb") — it renders the ORIGINAL bundled Crux Climb
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/CruxClimb.html`.

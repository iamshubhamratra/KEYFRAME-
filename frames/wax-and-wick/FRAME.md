# Wax & Wick — long-form kinetic-typography film (16:9)

A 5:08, 46-beat looping film for candle making, rendered from its own
...
## Design system
- Paper `#f8f0e2`, ink `#261e16`, accent `#c98a3c`, second accent
  `#7a6b8c`, tinted grounds `#eceae6` / `#f9e6ce`.
- **Gilda Display** display over **Mulish** body (bundled in the standalone).
...
- Animated SVG world behind every scene: wax pouring from a tilted pitcher, jars filling with wicks, a flickering flame, scent motes rising.

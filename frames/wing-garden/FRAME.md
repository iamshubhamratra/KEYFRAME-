---
version: alpha
name: Wing Garden — Frame
description: >
  butterflies flapping on sine paths, stems, soft rays Portrait-native 9:16 (15 authored beats, 44.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "WingGarden") — it renders the ORIGINAL bundled Wing Garden
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/WingGarden.html`.
...
15 authored beats (44.8s as shipped) across 11 distinct shapes.

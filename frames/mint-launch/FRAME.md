...
description: >
  ...
  One accent (#10B981) marks a single focal device per frame; #38BDF8 is the secondary.
...
Ground `#F7FCFA`. Text is high-contrast ink. `#10B981` is the one saturated device per frame
(a rule, dot, underline, or the single CTA fill); `#38BDF8` supports it. No third saturated hue in a
...
> Recipe: light ground + flow texture · one accent device · clear Bricolage Grotesque display moment · generous space.

---
version: alpha
name: Bonsai Bench — Frame
description: >
  swaying bonsai, falling needles, snips, moss dish Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "BonsaiBench") — it renders the ORIGINAL bundled Bonsai Bench
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/BonsaiBench.html`.

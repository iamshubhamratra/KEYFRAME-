---
version: alpha
name: Vault Twelve — Frame
description: >
  spinning dial, laser grid, tumbling coins, alarm sweep Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "VaultTwelve") — it renders the ORIGINAL bundled Vault Twelve
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/VaultTwelve.html`.

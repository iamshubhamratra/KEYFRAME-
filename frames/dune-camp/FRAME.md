---
version: alpha
name: Dune Camp — Frame
description: >
  rolling dunes, camel caravan silhouette, stars, tent glow Portrait-native 9:16 (14 authored beats, 41.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "DuneCamp") — it renders the ORIGINAL bundled Dune Camp
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/DuneCamp.html`.

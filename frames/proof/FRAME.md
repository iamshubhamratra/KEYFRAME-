...
name: Proof — Frame
description: >
  "PROOF" bakery world. Warm dough palette, rising/steam/oven animations. Portrait-native 9:16 (15 authored beats, 43.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Proof") — it renders the ORIGINAL bundled Proof
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Proof.html`.
...
15 authored beats (43.8s as shipped) across 8 distinct shapes.
...
| Shape | Notes |
|---|---|
| **Rise** | authored scene shape |
| **Steam** | authored scene shape |
| **Cutter** | authored scene shape |
| **Oven** | authored scene shape |
| **Layers** | authored scene shape |
| **Sprinkle** | authored scene shape |
| **Quote** | authored scene shape |

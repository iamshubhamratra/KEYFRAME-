# Slow Pour — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for coffee, rendered from its own
...
## Design system
- Paper `#f6ecdd`, ink `#231a15`, accent `#c4622c`, second accent
  `#6b8c7a`, tinted grounds `#e6eee8` / `#f7e0c8`.
- **Alfa Slab One** display over **Karla** body (bundled in the standalone).
...
- Animated SVG world behind every scene: spiralling pour, blooming bubbles, drips, live scale.

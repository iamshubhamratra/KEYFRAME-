---
version: alpha
name: Night Bazaar — Frame
description: >
  string lights, striped awning, smoke, swinging sign Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "NightBazaar") — it renders the ORIGINAL bundled Night Bazaar
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/NightBazaar.html`.

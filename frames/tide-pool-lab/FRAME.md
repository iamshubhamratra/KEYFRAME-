---
version: alpha
name: Tide Pool Lab — Frame
description: >
  starfish, anemone, sideways crab, shimmer Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "TidePoolLab") — it renders the ORIGINAL bundled Tide Pool Lab
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/TidePoolLab.html`.

...
name: Inkpress — Frame
description: >
  "INKPRESS" living type-specimen world. 17 unique scenes, dense, fast. Portrait-native 9:16 (17 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Inkpress") — it renders the ORIGINAL bundled Inkpress
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Inkpress.html`.
...
17 authored beats (44.4s as shipped) across 17 distinct shapes.
...
| Shape | Notes |
|---|---|
| **Masthead** | authored scene shape |
| **Weights** | authored scene shape |
| **Stretch** | authored scene shape |
| **Anatomy** | authored scene shape |
| **Press** | authored scene shape |
| **Kern** | authored scene shape |
| **Outline** | authored scene shape |
| **Glyphwall** | authored scene shape |
| **Ital** | authored scene shape |
| **Numerals** | authored scene shape |
| **Rain** | authored scene shape |
| **Pasteup** | authored scene shape |
| **Mixer** | authored scene shape |
| **Ticker** | authored scene shape |
| **Ampersand** | authored scene shape |
| **Countdown** | authored scene shape |

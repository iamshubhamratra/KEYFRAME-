...
name: Hamlet — Frame
description: >
  "HAMLET" pastoral village world. Hills, cottages, bunting. Portrait-native 9:16 (9 authored beats, 27.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Hamlet") — it renders the ORIGINAL bundled Hamlet
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Hamlet.html`.
...
| Shape | Notes |
|---|---|
| **Meadow** | authored scene shape |
| **Lane** | authored scene shape |
| **Notice** | authored scene shape |
| **Orchard** | authored scene shape |
| **Well** | authored scene shape |
| **Fete** | authored scene shape |

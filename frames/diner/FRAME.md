...
name: Diner — Frame
description: >
  "DINER" 50s roadside diner world. Neon, chrome, checkerboard. Portrait-native 9:16 (9 authored beats, 27.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Diner") — it renders the ORIGINAL bundled Diner
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Diner.html`.
...
| **Menu** | authored scene shape |
| **Booth** | authored scene shape |
| **Tab** | authored scene shape |
| **Regular** | authored scene shape |
| **Lastcall** | authored scene shape |

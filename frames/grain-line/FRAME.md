# Grain Line — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for hand woodwork, rendered from its own
...
## Design system
- Paper `#f4ead8`, ink `#251b13`, accent `#b06a2c`, second accent
  `#5f7a5f`, tinted grounds `#e8eee2` / `#f7e2c8`.
- **Cardo** display over **Barlow** body (bundled in the standalone).
...
- Animated SVG world behind every scene: plane throwing shavings, sawdust, dovetails cutting, clamps.

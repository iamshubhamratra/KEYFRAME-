---
version: alpha
name: Desert Neon — Frame
description: >
  motel night — neon cactus buzzing, tumbleweed, star wash Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "DesertNeon") — it renders the ORIGINAL bundled Desert Neon
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/DesertNeon.html`.

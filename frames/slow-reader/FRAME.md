...
# SLOW READER — literary / essay

The world is **the room at the end of the afternoon**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #191410 · `surface` #241d17 · `rule` #3d322a · `inkMuted` #9a8b7c · `ink` #f3ece1 · `accent` #d8a24e · `accent2` #8fa07a · `accentInk` #171208
...
**Vollkorn** sets display, **Alegreya Sans** sets the argument at a measure declared

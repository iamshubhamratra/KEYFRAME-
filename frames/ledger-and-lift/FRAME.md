# Ledger & Lift — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for personal finance, rendered from its own
...
## Design system
- Paper `#e9eef4`, ink `#0e131a`, accent `#3ce08c`, second accent
  `#5a7cff`, tinted grounds `#161f28` / `#1c1a26`.
- **Sora** display over **Inter Tight** body (bundled in the standalone).
...
- Animated SVG world behind every scene: candlestick chart building, tilting card, rising coins.

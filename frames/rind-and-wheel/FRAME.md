---
version: alpha
name: Rind & Wheel — Frame
description: >
  cheese wheels on shelves, drips, thermometer Portrait-native 9:16 (14 authored beats, 41.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "RindAndWheel") — it renders the ORIGINAL bundled Rind & Wheel
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/RindAndWheel.html`.

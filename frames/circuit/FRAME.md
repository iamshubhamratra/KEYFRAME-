...
name: Circuit — Frame
description: >
  "CIRCUIT" PCB electronics world. Traces, chips, scope. Portrait-native 9:16 (9 authored beats, 27.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Circuit") — it renders the ORIGINAL bundled Circuit
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Circuit.html`.
...
| **Bus** | authored scene shape |
| **Scope** | authored scene shape |
| **Multimeter** | authored scene shape |
| **Silkscreen** | authored scene shape |
| **Flash** | authored scene shape |

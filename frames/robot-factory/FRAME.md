---
version: alpha
name: Robot Factory — Frame
description: >
  conveyor belt, robot arm placing crates, warning beacon Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "RobotFactory") — it renders the ORIGINAL bundled Robot Factory
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/RobotFactory.html`.

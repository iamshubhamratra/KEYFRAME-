---
version: alpha
name: Jungle Trek — Frame
description: >
  "Jungle Trek" Deep rainforest: layered swaying leaves framing the edges, wandering fireflies, hanging vines, drifting mist. Alfa Slab One + Cabin. Portrait-native 9:16 (18 authored beats, 49.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "JungleTrek") — it renders the ORIGINAL bundled Jungle Trek
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/JungleTrek.html`.

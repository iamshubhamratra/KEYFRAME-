---
version: alpha
name: Road Trip — Frame
description: >
  "Road Trip" Friends on the road: paper-map ground, a dashed route drawing itself, a scooting van, popping location pins, taped polaroids. Permanent Marker + Karla. Portrait-native 9:16 (18 authored beats, 49.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "RoadTrip") — it renders the ORIGINAL bundled Road Trip
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/RoadTrip.html`.

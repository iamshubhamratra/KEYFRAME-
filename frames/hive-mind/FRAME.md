# Hive Mind — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for beekeeping, rendered from its own
...
## Design system
- Paper `#fdf4dd`, ink `#33280f`, accent `#e0a92c`, second accent
  `#7a8c3f`, tinted grounds `#eceedc` / `#faead0`.
- **Fredoka** display over **Quicksand** body (bundled in the standalone).
...
- Animated SVG world behind every scene: comb cells filling, bees on figure-eights, smoker.

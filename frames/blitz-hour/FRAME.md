# Blitz Hour — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for chess, rendered from its own
...
## Design system
- Paper `#f0e9da`, ink `#1c1813`, accent `#b3452e`, second accent
  `#4d6b8c`, tinted grounds `#e6eae4` / `#f6e2d4`.
- **DM Serif Display** display over **DM Sans** body (bundled in the standalone).
...
- Animated SVG world behind every scene: knight hopping L-moves, fast clock with falling flag.

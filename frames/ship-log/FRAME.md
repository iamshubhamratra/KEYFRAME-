# Ship Log — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for dev tooling / CI, rendered from its own
...
## Design system
- Paper `#e6edf3`, ink `#0d1117`, accent `#4ad2a0`, second accent
  `#6a8cff`, tinted grounds `#161d24` / `#1a1620`.
...
- Animated SVG world behind every scene: commit graph drawing, terminal typing, packets on a wire.

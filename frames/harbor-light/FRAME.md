---
version: alpha
name: Harbor Light — Frame
description: >
  sweeping beam, waves, gulls, fog band Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "HarborLight") — it renders the ORIGINAL bundled Harbor Light
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/HarborLight.html`.

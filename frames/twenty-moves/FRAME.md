---
version: alpha
name: Twenty Moves — Frame
description: >
  cube face tiles cycling, timer, scramble arrows Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "TwentyMoves") — it renders the ORIGINAL bundled Twenty Moves
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/TwentyMoves.html`.

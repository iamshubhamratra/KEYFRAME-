...
name: Altitude — Frame
description: >
  "ALTITUDE" sky/balloon world. Clouds, balloons, altimeters. Portrait-native 9:16 (9 authored beats, 27.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Altitude") — it renders the ORIGINAL bundled Altitude
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Altitude.html`.
...
| Shape | Notes |
|---|---|
| **Liftoff** | authored scene shape |
| **Currents** | authored scene shape |
| **Basket** | authored scene shape |
| **Altimeter** | authored scene shape |
| **Postcard** | authored scene shape |
| **Horizon** | authored scene shape |

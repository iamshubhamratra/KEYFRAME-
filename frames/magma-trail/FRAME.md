---
version: alpha
name: Magma Trail — Frame
description: >
  volcano glow, lava bombs, plume, shimmer Portrait-native 9:16 (15 authored beats, 44.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "MagmaTrail") — it renders the ORIGINAL bundled Magma Trail
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/MagmaTrail.html`.

# Blistered Crust — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for wood-fired pizza / long-proved dough, rendered from its own
...
## Design system
- Paper `#faf0dc`, ink `#231710`, accent `#d13c2c`, second accent
  `#4a8c46`, tinted grounds `#e8eedc` / `#fae2ce`.
- **Lilita One** display over **Urbanist** body (bundled in the standalone).
...
- Animated SVG world behind every scene: a pizza with cheese and basil turning, char blisters fixed round the rim, a domed oven flickering, flour drifting and a peel.

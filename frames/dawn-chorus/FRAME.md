# Dawn Chorus — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for birdwatching, rendered from its own
...
## Design system
- Paper `#f3efe4`, ink `#1e2a34`, accent `#e0913c`, second accent
  `#4d7f8c`, tinted grounds `#e6ece8` / `#f7e6d2`.
- **Fraunces** display over **Mulish** body (bundled in the standalone).
...
- Animated SVG world behind every scene: birds flapping on sine paths, four on a wire, rising sun.

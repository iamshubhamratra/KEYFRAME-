---
version: alpha
name: Reef Build — Frame
description: >
  coral branches growing, schooling fish, bubbles, light rays Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "ReefBuild") — it renders the ORIGINAL bundled Reef Build
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/ReefBuild.html`.

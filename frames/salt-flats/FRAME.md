# Salt Flats — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for land speed racing, rendered from its own
...
## Design system
- Paper `#fbfaf4`, ink `#2a2620`, accent `#d94a2c`, second accent
  `#2c6b9e`, tinted grounds `#eef0ea` / `#f8e4d8`.
- **Michroma** display over **Saira** body (bundled in the standalone).
...
- Animated SVG world behind every scene: a streamliner running across a white salt plain, heat-shimmer bands, blinking timing posts, an mph readout ticking.

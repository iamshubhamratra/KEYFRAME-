# Silver Run — long-form kinetic-typography film (16:9)

A 5:08, 46-beat looping film for river ecology / eel monitoring, rendered from its own
...
## Design system
- Paper `#eef4f2`, ink `#0c2020`, accent `#c4a83c`, second accent
  `#3c8c8c`, tinted grounds `#e2eeea` / `#f6ecd4`.
- **Fraunces** display over **Nunito Sans** body (bundled in the standalone).
...
- Animated SVG world behind every scene: transparent eels wriggling upstream, scrolling current lines, a lift net raising and lowering, a live tally counter under night stars.

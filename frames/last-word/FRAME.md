...
# LAST WORD — opinion / manifesto

The world is **a belfry room**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #f0ece3 · `surface` #fbf9f4 · `rule` #cbc4b5 · `inkMuted` #6e675c · `ink` #16130d · `accent` #7a2f2f · `accent2` #b08c3a · `accentInk` #fbf9f4
...
**Abril Fatface** sets display, **Lora** sets the argument at a measure declared

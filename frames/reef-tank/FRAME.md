# Reef Tank — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for marine aquarium, rendered from its own
...
## Design system
- Paper `#eef4f2`, ink `#0b1c22`, accent `#ff8a5c`, second accent
  `#3fd0c4`, tinted grounds `#123038` / `#1c2630`.
- **Outfit** display over **Nunito Sans** body (bundled in the standalone).
...
- Animated SVG world behind every scene: fish schooling in a glass box, swaying anemones, bubbles.

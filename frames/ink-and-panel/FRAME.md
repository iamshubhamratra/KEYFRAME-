---
version: alpha
name: Ink & Panel — Frame
description: >
  panel grid drawing, halftone, speed lines, SFX burst Portrait-native 9:16 (0 authored beats, 0s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "InkAndPanel") — it renders the ORIGINAL bundled Ink & Panel
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/InkAndPanel.html`.
...
0 authored beats (0s as shipped) across 0 distinct shapes.
...
| Shape | Notes |
|---|---|
| _(scene shapes not declared in OM_SCENES)_ | |

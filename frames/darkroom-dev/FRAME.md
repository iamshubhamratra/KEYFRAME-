---
version: alpha
name: Darkroom Dev — Frame
description: >
  safelight glow, hanging film strips, tray ripples Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "DarkroomDev") — it renders the ORIGINAL bundled Darkroom Dev
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/DarkroomDev.html`.

---
version: alpha
name: Turbine Coast — Frame
description: >
  rotating turbines, waves, pylon, gull Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "TurbineCoast") — it renders the ORIGINAL bundled Turbine Coast
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/TurbineCoast.html`.

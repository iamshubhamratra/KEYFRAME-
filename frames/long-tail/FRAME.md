...
# LONG TAIL — science / explainer

The world is **a monitoring station**. A typography-led film for writing that already exists:
the argument carries the picture, not the other way round.

## The palette is a luminance ladder

`bg` #eeeae1 · `surface` #fbf9f4 · `rule` #cac3b5 · `inkMuted` #6c665b · `ink` #14120d · `accent` #8c3f2f · `accent2` #3f6c8c · `accentInk` #fbf9f4
...
**Krona One** sets display, **Kumbh Sans** sets the argument at a measure declared

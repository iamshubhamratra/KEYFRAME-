# Tinsel Row — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for christmas / street lights, rendered from its own
...
## Design system
- Paper `#f6f2e6`, ink `#101c26`, accent `#c8342e`, second accent
  `#2e7a52`, tinted grounds `#e4eee6` / `#f8e2d8`.
- **Mountains of Christmas** display over **Karla** body (bundled in the standalone).
...
- Animated SVG world behind every scene: snow falling, two sagging strings of bulbs blinking, lit tree with star, wreath turning.

---
version: alpha
name: City Pulse — Frame
description: >
  skyline window grids flicking on, crane, blinking antennas Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "CityPulse") — it renders the ORIGINAL bundled City Pulse
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/CityPulse.html`.

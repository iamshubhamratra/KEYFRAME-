---
version: alpha
name: Ember Roast — Frame
description: >
  coffee roastery — steam curls, rotating drum, falling beans Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "EmberRoast") — it renders the ORIGINAL bundled Ember Roast
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/EmberRoast.html`.
...
15 authored beats (44.6s as shipped) across 10 distinct shapes.

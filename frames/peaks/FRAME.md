...
name: Peaks — Frame
description: >
  "PEAKS" alpine expedition world. Ridgelines, snow, route flags. Portrait-native 9:16 (9 authored beats, 27.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Peaks") — it renders the ORIGINAL bundled Peaks
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Peaks.html`.
...
| **Ascent** | authored scene shape |
| **Summitcam** | authored scene shape |
| **Altimeter** | authored scene shape |
| **Ledge** | authored scene shape |
| **Flag** | authored scene shape |

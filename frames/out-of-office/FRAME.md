# Out of Office — long-form kinetic-typography film (16:9)

A 5:02, 45-beat looping film for annual leave / holiday travel, rendered from its own
...
## Design system
- Paper `#f6f1e4`, ink `#12303f`, accent `#f2803c`, second accent
  `#2ca0b8`, tinted grounds `#e2eeee` / `#f8e6d2`.
- **Righteous** display over **Be Vietnam Pro** body (bundled in the standalone).
...
- Animated SVG world behind every scene: sun with turning rays, paper plane arcing on a dashed route, rolling suitcase bobbing, boarding pass with barcode.

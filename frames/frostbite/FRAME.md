...
description: >
  "FROSTBITE" arctic-expedition world. Aurora, snow, ice. Portrait-native 9:16 (9 authored beats, 27.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Frostbite") — it renders the ORIGINAL bundled Frostbite
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Frostbite.html`.
...
| Shape | Notes |
|---|---|
| **Basecamp** | authored scene shape |
| **Ropeline** | authored scene shape |
| **Lodge** | authored scene shape |
| **Mercury** | authored scene shape |
| **Wire** | authored scene shape |
| **Summit** | authored scene shape |

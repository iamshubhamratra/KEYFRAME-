---
version: alpha
name: Spinnaker Cup — Frame
description: >
  heeled yacht, spinnaker, buoy, burgee Portrait-native 9:16 (14 authored beats, 41.4s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "SpinnakerCup") — it renders the ORIGINAL bundled Spinnaker Cup
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/SpinnakerCup.html`.
...
14 authored beats (41.4s as shipped) across 10 distinct shapes.

...
name: Postmark — Frame
description: >
  "POSTMARK" vintage mail world. Envelopes, stamps, airmail. Portrait-native 9:16 (9 authored beats, 27.8s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "Postmark") — it renders the ORIGINAL bundled Postmark
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Postmark.html`.
...
| Shape | Notes |
|---|---|
| **Sorting** | authored scene shape |
| **Route** | authored scene shape |
| **Parcel** | authored scene shape |
| **Ledger** | authored scene shape |
| **Seal** | authored scene shape |
| **Send** | authored scene shape |

---
version: alpha
name: Fade Parlor — Frame
description: >
  barber pole spin, scissors, mirror bulbs Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "FadeParlor") — it renders the ORIGINAL bundled Fade Parlor
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/FadeParlor.html`.

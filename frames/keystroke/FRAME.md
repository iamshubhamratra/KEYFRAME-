...
renderer: >
  ...
  "template": "Keystroke") — it renders the ORIGINAL bundled Keystroke
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/Keystroke.html`.
...
5 authored beats (20.2s as shipped) across 5 distinct shapes.
...
| Shape | Notes |
|---|---|
| **Boot** | authored scene shape |
| **Editor** | authored scene shape |
| **Terminal** | authored scene shape |
| **Refactor** | authored scene shape |

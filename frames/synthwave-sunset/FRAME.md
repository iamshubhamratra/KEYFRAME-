---
version: alpha
name: Synthwave Sunset — Frame
description: >
  striped sun over a scrolling perspective grid Portrait-native 9:16 (18 authored beats, 49.9s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "SynthwaveSunset") — it renders the ORIGINAL bundled Synthwave Sunset
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/SynthwaveSunset.html`.

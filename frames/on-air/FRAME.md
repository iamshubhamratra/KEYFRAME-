...
name: On Air — Frame
description: >
  waveform bars, blinking sign, mic, sound rings Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "OnAir") — it renders the ORIGINAL bundled On Air
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/OnAir.html`.

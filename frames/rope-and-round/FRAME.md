# Rope & Round — long-form kinetic-typography film (16:9)

A ~5-minute, 40-beat looping film for boxing gym, rendered from its own
...
## Design system
- Paper `#f2f0ec`, ink `#17171a`, accent `#e03a3a`, second accent
  `#c9a52c`, tinted grounds `#e6e8ea` / `#f6e0e0`.
...
- Animated SVG world behind every scene: swinging heavy bag, skipping-rope arc, ring ropes, bell.

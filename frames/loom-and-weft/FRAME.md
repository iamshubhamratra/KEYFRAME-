---
version: alpha
name: Loom & Weft — Frame
description: >
  warp threads, shuttle crossing, heddle lift, yarn cones Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "LoomAndWeft") — it renders the ORIGINAL bundled Loom & Weft
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/LoomAndWeft.html`.

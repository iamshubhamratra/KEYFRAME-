---
version: alpha
name: Velvet Brass — Frame
description: >
  jazz lounge — spotlight sweep, rising notes, piano strip Portrait-native 9:16 (15 authored beats, 44.6s as shipped), rendered from its own bundle — only the words and pictures change.
...
renderer: >
  ...
  "template": "VelvetBrass") — it renders the ORIGINAL bundled Velvet Brass
...
Portrait-native (9:16). Source bundle: `server/public/omelette-templates/VelvetBrass.html`.

...
export const PACK_LORE = {
  ...
  genesis: {
    ...
    font: "'Sora'", tracking: "-.02em", demo: "A world, alive",
  ...
  kaleido: {
    ...
    font: "'Syne'", tracking: "-.02em", demo: "Refract the light",
  ...
  voltage: {
    ...
    font: "'Orbitron'", tracking: ".02em", demo: "FEEL THE SURGE",
  ...
  flagship: {
    ...
    font: "'Space Grotesk'", tracking: "-.02em", demo: "The Launch Film",
  ...
  brightlife: {
    ...
    font: "'Space Grotesk'", tracking: "-.02em", demo: "Daylight Cinema",
  ...
  "bauhaus-riot": {
    ...
    font: "'Archivo Black'", tracking: "0", demo: "STAMP. SNAP. SHOUT.",
  ...
  "bloom-fable": {
    ...
    font: "'Fraunces'", tracking: "-.01em", demo: "Grown with heart",
  ...
  "blueprint-atelier": {
    ...
    font: "'IBM Plex Mono'", tracking: ".02em", demo: "BUILT TO SPEC",
  ...
  "sumi-kaze": {
    ...
    font: "'Zen Old Mincho'", tracking: "0", demo: "墨 Ink in motion",
  ...
  "orrery-brass": {
    ...
    font: "'Cormorant Garamond'", tracking: ".01em", demo: "As the wheels turn",
  ...
  claymotion: {
    ...
    font: "'Baloo 2'", tracking: "0", demo: "Squish. Snap. Play.",
  ...
  "folk-stitch": {
    ...
    font: "'Alfa Slab One'", tracking: ".02em", demo: "SEWN WITH LOVE",
  ...
  "abyssal-glow": {
    ...
    font: "'Comfortaa'", tracking: ".01em", demo: "Light from below",

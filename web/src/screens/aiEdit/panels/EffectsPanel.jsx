...
import { EFFECTS_OPTIONS, fmtTcShort } from "../../../editFormat.js";
...
// all-effects switch and auto jump cuts, then each zoom / punch-in with its switch and a 1.05–1.40×
// zoom, and each graphic (hook title, keyword, stat, lower third, CTA) with its switch and text
// fields that count characters against the card's limit.
...
const TRANSITIONS = [["CUT", "Cut"], ["DIP_BLACK", "Dip to black"], ["DIP_WHITE", "Dip to white"], ["FLASH", "Flash"], ["CROSSFADE", "Crossfade"]];

...
// jobs.json (models/job.js) and auth-store.json (models/user.js). Neither can host this —
// models/job.js is a Map keyed by job id with job-shaped records and destructive boot
...
// database for ~200 rows and a handful of admins. models/user.js is the blueprint;

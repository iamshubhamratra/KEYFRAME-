...
8. **sfx** on the moments that matter — the hook impact, each major transition, the CTA land (a whoosh, soft click, riser, pop). Roughly every other scene; never more than 2 per scene.

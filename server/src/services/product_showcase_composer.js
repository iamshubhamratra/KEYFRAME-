...
function bCta(scene, ctx, logo) {
  ...
  const html = `${open(id, ctx)}<div class="ps-safe">
    ...
    <div class="ps-wordmark" style="margin-top:3.4cqw;">${chars}</div>
...
function styleBlock(theme, portrait) {
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  .ps-wordmark { display:flex; font-family:${theme.displayStack}; font-weight:800; font-size:11cqw; letter-spacing:-0.02em; color:${theme.ink}; }

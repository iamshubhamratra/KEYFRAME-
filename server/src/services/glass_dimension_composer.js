...
function bCta(scene, ctx, logo) {
  ...
  const inner = `<div style="position:relative;z-index:2;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;padding:8%;text-align:center;">
    ...
    <div class="gd-wordmark" style="font-size:${r(Math.min(9, fitCap(word)))}cqw;margin-top:3cqw;">${chars}</div>
...
function styleBlock(theme, portrait) {
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  .gd-display { font-family:${theme.displayStack}; font-weight:700; line-height:0.98; letter-spacing:-0.02em; color:${theme.ink}; ${displayShadow(theme.ground)} }
  .gd-h1 { font-family:${theme.displayStack}; font-weight:700; line-height:1.04; letter-spacing:-0.02em; color:${theme.ink}; ${displayShadow(theme.ground)} }
  ...
  .gd-wordmark { display:flex; flex-wrap:wrap; justify-content:center; text-align:center; gap:0 0.26em; max-width:92%; font-family:${theme.displayStack}; font-weight:800; font-size:9cqw; letter-spacing:-0.02em; color:${theme.ink}; }

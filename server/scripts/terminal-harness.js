...
// node scripts/terminal-harness.js <outDir> [W] [H] [shot]   ("shot" adds a gate-monitor asset)
...
const built = terminal.buildComposition({ storyboard, dims: { width: W, height: H, fps: 30 }, framePack: "terminal-departures", captionCues, assets });
...
console.log(`[terminal-harness] wrote ${outDir} (${W}x${H}, ${storyboard.scenes.length} scenes${withShot ? ", +gate monitor" : ""})`);
